...
object Info {
  ...
  def gdelt1(): GDELT = {
    val id=833246242
    val day=20180325
    val monthYear=201803
    val year=2018
    val fractionDate=2018.2329
    val actor1Code=""
    val actor1Name=""
    val actor1CountryCode=""
    val actor1KnownGroupCode=""
    val actor1EthnicCode=""
    val actor1Religion1Code=""
    val actor1Religion2Code=""
    val actor1Type1Code=""
    val actor1Type2Code=""
    val actor1Type3Code=""
    val actor2Code="USA"
    val actor2Name="UNITED STATES"
    val actor2CountryCode="USA"
    val actor2KnownGroupCode=""
    val actor2EthnicCode=""
    val actor2Religion1Code=""
    val actor2Religion2Code=""
    val actor2Type1Code=""
    val actor2Type2Code=""
    val actor2Type3Code=""
    val isRootEvent=0
    val eventCode="036"
    val eventBaseCode="036"
    val eventRootCode="03"
    val quadClass="1"
    val goldsteinScale=4.0
    val numMentions=1
    val numSources=1
    val numArticles=1
    val avgTone=0.93592512598992
    val actor1Geo_Type=0
    val actor1Geo_Fullname=""
    val actor1Geo_CountryCode=""
    val actor1Geo_ADM1Code=""
    val actor1Geo_Lat=0
    val actor1Geo_Long=0
    val actor1Geo_FeatureID=0
    val actor2Geo_Type=2
    val actor2Geo_Fullname="Arizona, United States"
    val actor2Geo_CountryCode="US"
    val actor2Geo_ADM1Code="USAZ"
    val actor2Geo_Lat=33.7712
    val actor2Geo_Long=0-111.388
    val actor2Geo_FeatureID=0
    val actionGeo_Type=2
    val actionGeo_Fullname="New Hampshire, United States"
    val actionGeo_CountryCode="US"
    val actionGeo_ADM1Code="USNH"
    val actionGeo_Lat=43.4108
    val actionGeo_Long=0-71.5653
    val actionGeo_FeatureID=0
    val dateAdded=20190325
    val sourceUrl="https://www.fosters.com/news/20190324/bittersweet-ceremony-marks-end-of-kc-135-tankers-at-pease"
  ...
  def gdelt2(): GDELT = {
    ...
    val fractionDate=2018.2329
    val actor1Code="BUS"
    val actor1Name="INDUSTRY"
    val actor1CountryCode=""
    val actor1KnownGroupCode=""
    val actor1EthnicCode=""
    val actor1Religion1Code=""
    val actor1Religion2Code=""
    val actor1Type1Code="BUS"
    val actor1Type2Code=""
    val actor1Type3Code=""
    val actor2Code=""
    val actor2Name=""
    val actor2CountryCode=""
    val actor2KnownGroupCode=""
    val actor2EthnicCode=""
    val actor2Religion1Code=""
    val actor2Religion2Code=""
    ...
    val isRootEvent=0
    val eventCode="020"
    val eventBaseCode="020"
    val eventRootCode="02"
    val quadClass="1"
    val goldsteinScale=3.0
    val numMentions=2
    val numSources=1
    val numArticles=2
    val avgTone=0
    val actor1Geo_Type=3
    val actor1Geo_Fullname="Los Angeles, California, United States"
    val actor1Geo_CountryCode="US"
    val actor1Geo_ADM1Code="USCA"
    val actor1Geo_Lat=34.0522
    val actor1Geo_Long=0-118.244
    val actor1Geo_FeatureID=1662328
    val actor2Geo_Type=0
    val actor2Geo_Fullname=""
    val actor2Geo_CountryCode=""
    val actor2Geo_ADM1Code=""
    val actor2Geo_Lat=0
    val actor2Geo_Long=0
    val actor2Geo_FeatureID=0
    val actionGeo_Type=3
    val actionGeo_Fullname="Los Angeles, California, United States"
    val actionGeo_CountryCode="US"
    val actionGeo_ADM1Code="USCA"
    val actionGeo_Lat=34.0522
    val actionGeo_Long=0-118.244
    val actionGeo_FeatureID=1662328
    val dateAdded=20190325
    val sourceUrl="http://www.940wfaw.com/news/flight-school-calls-for-more-women-pilots-after-photo-of-mother-daughter-duo-flying-plane-goes-viral/"
